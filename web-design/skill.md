...
- Typography
  ...
  - Font selection: choose fonts that are professional - avoid generic fonts like Arial, Inter, Roboto, system fonts
...
- Component Design
  ...
  - Buttons: flat and square that animate on hover
  - Cards: flat and square, subtle shadow or border for definition, consistent padding (16-24px), hover state for
    interactive cards, group related content
